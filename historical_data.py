...
ibkr = InteractiveBrokerConnector({'ip_address':'127.0.0.1','port':4002,'client_id':1237})
...
ticker = 'NIO'
end_date = datetime.datetime(2021, 5, 17, 23, 59, 59)

#Get and save 5 seconds, 1 min and 5 mins
time_durations = [TimeDuration.DAY_3,TimeDuration.DAY_1,TimeDuration.DAY_1]
candlestick_durations = [CandleStickDuration.MIN_5,CandleStickDuration.MIN_1,CandleStickDuration.SEC_5]
