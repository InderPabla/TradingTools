...
if __name__ == '__main__':
    ...
    #'QQQ','SPY','NIO','AMD','SIDU','CCL','AAPL'
    #'QQQ','SPY','NIO','OXY','COIN','META','AMD'
    #'QQQ','SPY','NIO','OXY','META','LI','COIN'
    #'QQQ','SPY','NIO','CCL','XPEV','LI','COIN'
    #'QQQ','SPY','NIO','LI','OXY','AMD','CSCO'
    #'QQQ','SPY','NIO','LI','OXY','XPEV','NKE'
    #'QQQ','SPY','NIO','LI','OXY','META','AMD'
    #'QQQ','SPY','OXY','COIN','AMD','CCL','LI'
    #'QQQ','SPY','CCL','XPEV','MU','AMD','KSS'
    #'QQQ','SPY','CCL','OXY','MU','COIN','KSS'
    #'QQQ','SPY','DASH','UBER','TDOC','NIO','CCL'
    #'QQQ','SPY','NIO','OXY','AMD','SHOP'
    #'QQQ','SPY','AMD','ROKU','PLUG','INTC'
    
    #08/01 'QQQ','SPY','AMD','NIO','ROKU','BABA'
    #08/02 'QQQ','SPY','AMD','NIO','BABA','PINS'
    #08/03 'QQQ','SPY','AMD','SOFI','OXY','META','PYPL'
    
    tickers = ['QQQ','SPY','AMD','SOFI','OXY','META','PYPL']
